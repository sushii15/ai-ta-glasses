...
async function parsePdf(buffer: Buffer): Promise<string> {
  ...
  // Point to the real worker file so pdfjs can spawn it
...
if (!GEMINI_API_KEY) throw new Error("Missing GEMINI_API_KEY environment variable. See README.md for setup instructions.");
